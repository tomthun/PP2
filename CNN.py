...
class SimpleCNN(nn.Module):
    ...
    def __init__(self,num_tags,inp,outp,dev):
        ...
        self.layer1 = nn.Sequential(
            nn.Conv2d(128, 64, kernel_size=(7,1),  padding = (3,0)), nn.LeakyReLU(), nn.BatchNorm2d(64)) 
        self.layer2 = nn.Sequential(
            nn.Conv2d(64, outp, kernel_size=(1,1),  padding=(0,0)), nn.Sigmoid(), nn.BatchNorm2d(outp))     
